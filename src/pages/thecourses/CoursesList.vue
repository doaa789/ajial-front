        ...
        <template v-slot:form @submit.prevent="submitForm">
          ...
          <div class="container-course" v-if="courseDetails==='list'">
            ...
            :key="course.id">
                ...
                <div class="bottom">
                <base-button  class="btn" @click="this.courseDetails='learnMore'">معرفة المزيد</base-button>
                <base-button class="btn-active" @click="this.courseDetails='entercourse'">البدء بالتعلم</base-button>
                </div>
            </base-card>
            </div>

            <div class="container-course" v-else-if="courseDetails==='learnMore'">
              <div class="course-container">
                <div class="course-right">
                    <p class="title"> سكراتش للاطفال</p>
                    <p>سنتعلم في هذه الدورة أساسيات البرمجة، والتي تحتوي على العديد من الأنشطة التطبيقية والعملية باستخدام برنامج سكراتش، وهو أحد لغات البرمجة (التي طورها معهد ماساتشوستس للتكنولوجيا) ومن خلالها سنساعدك على اكتساب مهارات هامة في عالم البرمجة بطريقة ممتعة وسهلة عن طريق الألعاب، ولتكون في متناول الجميع بسهولة ويسر، لأنها تحتوي على مجموعة من الأوامر التي يتم تركيبها لتسهل استخدام التكنولوجيا في التعامل مع الصور، الرسومات، الصوت والفيديو، والموسيقى بطرق تفاعلية سهلة الإنشاء، والفهم والتطوير لألعاب وقصص وبرامج تطبيقية متنوعة</p>
                    <p class="title"> الفئة المستهدفة</p>
                     <ul>
                         <li> الأطفال والمبتدئون الراغبون في تعلم برمجة الألعاب (تبدأ أعمارهم من 7-8 سنوات)</li>
                         <li>أي شخص لديه شغف في تعلم البرمجة وعلوم الكمبيوتر حتى لو لم يمتلك المهارات الأساسية</li>
                     ...
                     <ul class="list">
                         ...
                         <li><img  class="true" src="/images/true.png" alt="true">
                             تعلم بعض لغات البرمجة بسرعة وسهولة، وتنفيذ البرامج وكتابتها بطريقة سلسة.</li>
                         <li><img  class="true" src="/images/true.png" alt="true">
                             رسم الخطوط والأشكال والرسومات المتحركة وإضافة المؤثرات البصرية الرائعة</li>
                     </ul>
                ...
                <div class="course-left">
                    <img class="image" src="/images/scratch.png" alt="course">
                     ...
                     <base-button class="enter" @click="this.courseDetails='entercourse'">البدء بالتعلم</base-button>
                </div>
              </div>
            </div>
            <div class="container-video" v-else>
                <video src="/images/computer.mp4" controls width="650"></video>
                <ul class="list-session">
                        ...
                        <img  class="lock" src="/images/open-lock.png" alt="lock">
                         ...
                         <li class="answerMe" @click="this.question='true'"><img  class="video" src="/images/video1.png" alt="video">
                        ...
                        <div class="true-false">
                            <img class="false" src="/images/true.png" alt="true">
                            <img  class="false" src="/images/false.png" alt="false">
                        </div>
                        ...
                        <img  class="lock" src="/images/close-lock.png" alt="lock">
                         ...
                         <li><img  class="video" src="/images/video1.png" alt="video">
                             الدرس الرابع: شرح اوامر المظاهر في سكراتش والتطبيق عليها
                        <img  class="lock" src="/images/close-lock.png" alt="lock">
                        </li>
                     </ul>
            </div>
...
li {
  box-shadow: 0 2px 8px rgba(37, 218,117, 0.6);
  text-align: center;
  color: #25da75;
  border-radius: 12px;
  padding: 0.5rem;
...
li:hover{
  box-shadow: 0 20px 80px rgba(37, 218, 117, 0.9);
}
a{
